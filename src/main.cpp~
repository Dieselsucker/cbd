...
unsigned int nStakeMinAge = 60 * 60 * 5; // 5 hours
...
const string strMessageMagic = "cbd Signed Message:\n";
...
int64_t GetProofOfWorkReward(int64_t nFees)
{
    ...
    if(pindexBest->nHeight < 10) // CBD SUPPLY
    {
        nSubsidy = 5000000 * COIN;
    }
    else if(pindexBest->nHeight < 900000) // 0 
    {
        nSubsidy = 0 * COIN;
    }
...
// cbd: attempt to generate suitable proof-of-stake
...
bool CheckDiskSpace(uint64_t nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "cbd", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        const char* pszTimestamp = "CBD RELAX YOUR MIND";
        CTransaction txNew;
        txNew.nTime = 1476205362;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        //// debug print
        assert(block.hashMerkleRoot == uint256("0x193fde3632b368477872bf2c551ae9780cfd2602bac82920e392813ca9fe5eed"));
        block.print();
